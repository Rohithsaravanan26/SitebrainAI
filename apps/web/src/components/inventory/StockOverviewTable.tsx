...
export const INVENTORY_ITEMS: InventoryItem[] = [
  {
    ...
    targetStock: 80,
    unitCost: 1240,
    supplierName: 'BlueScope Steel',
    storageLocation: 'Yard A — Bay 3',
    qrCodeData: 'SITEBRAIN:SKU:STL-N16-12M',
  ...
  },
  {
    ...
    unitCost: 1380,
    supplierName: 'BlueScope Steel',
    storageLocation: 'Yard A — Bay 4',
    qrCodeData: 'SITEBRAIN:SKU:STL-N20-12M',
    createdAt: '2026-06-01T00:00:00Z',
    updatedAt: '2026-07-24T00:00:00Z',
  },
  {
    ...
    targetStock: 300,
    unitCost: 68,
    supplierName: 'Boral Timber',
    storageLocation: 'Yard B — Rack 1',
    qrCodeData: 'SITEBRAIN:SKU:FRM-PLY-17MM',
    createdAt: '2026-06-01T00:00:00Z',
    updatedAt: '2026-07-24T00:00:00Z',
  },
  {
    ...
    targetStock: 150,
    unitCost: 185,
    supplierName: 'Holcim Aust.',
    storageLocation: 'On-Call Delivery',
    qrCodeData: 'SITEBRAIN:SKU:CON-M25-RMX',
    createdAt: '2026-06-01T00:00:00Z',
    updatedAt: '2026-07-24T00:00:00Z',
  },
  {
    ...
    targetStock: 80,
    unitCost: 32,
    supplierName: 'Safety HQ',
    storageLocation: 'Site Office',
    qrCodeData: 'SITEBRAIN:SKU:PPE-HLM-C3',
    createdAt: '2026-06-01T00:00:00Z',
    updatedAt: '2026-07-24T00:00:00Z',
  },
  {
    ...
    supplierName: 'Safety HQ',
    storageLocation: 'Site Office',
    qrCodeData: 'SITEBRAIN:SKU:PPE-VIS-C3',
    createdAt: '2026-06-01T00:00:00Z',
    updatedAt: '2026-07-24T00:00:00Z',
  },
  {
    ...
    targetStock: 30,
    unitCost: 95,
    supplierName: 'Ramset Aust.',
    storageLocation: 'Yard A — Cage',
    qrCodeData: 'SITEBRAIN:SKU:BLT-ANC-M24',
    createdAt: '2026-06-01T00:00:00Z',
    updatedAt: '2026-07-24T00:00:00Z',
  },
  {
    ...
    unitCost: 44,
    supplierName: 'Boral Timber',
    storageLocation: 'Yard B — Row 2',
    qrCodeData: 'SITEBRAIN:SKU:FRM-JCK-PRP',
    createdAt: '2026-06-01T00:00:00Z',
    updatedAt: '2026-07-24T00:00:00Z',
  },
  {
    ...
    targetStock: 800,
    unitCost: 4.2,
    supplierName: 'Parchem Constr.',
    storageLocation: 'Hazmat Store',
    qrCodeData: 'SITEBRAIN:SKU:CHM-CUR-A10',
    createdAt: '2026-06-01T00:00:00Z',
    updatedAt: '2026-07-24T00:00:00Z',
  },
  {
    ...
    targetStock: 600,
    unitCost: 3.8,
    supplierName: 'Clipsal Elec.',
    storageLocation: 'Electrical Store',
    qrCodeData: 'SITEBRAIN:SKU:ELC-CAB-2C4',
    createdAt: '2026-06-01T00:00:00Z',
    updatedAt: '2026-07-24T00:00:00Z',
  },
];
...
export const StockOverviewTable: React.FC<StockOverviewTableProps> = ({
  ...
  const pct = (item: InventoryItem) =>
    Math.min(100, Math.round((item.currentStock / item.targetStock) * 100));
      ...
      <table className="w-full text-xs">
        <thead className="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800">
          <tr>
            ...
            <th className="text-right px-3 py-2.5 font-bold uppercase tracking-wider text-slate-500 text-[10px] hidden md:table-cell">
              Available
            </th>
            <th className="text-left px-3 py-2.5 font-bold uppercase tracking-wider text-slate-500 text-[10px] hidden lg:table-cell">
              Stock Level
            </th>
            <th className="text-left px-3 py-2.5 font-bold uppercase tracking-wider text-slate-500 text-[10px] hidden xl:table-cell">
              Location
            </th>

...
const POS: PurchaseOrder[] = [
  {
    ...
    supplierId: 's3',
    supplierName: 'Holcim Australia',
    status: 'DELIVERED',
    totalAmount: 14800,
    expectedDelivery: '2026-07-24T06:00:00Z',
  ...
  },
  {
    ...
    status: 'ORDERED',
    totalAmount: 27640,
    expectedDelivery: '2026-07-26T08:00:00Z',
  ...
  },
  {
    ...
    supplierId: 's2',
    supplierName: 'Boral Timber & Products',
    status: 'PARTIALLY_RECEIVED',
    totalAmount: 12240,
    expectedDelivery: '2026-07-25T07:00:00Z',
    createdAt: '2026-07-22T00:00:00Z',
  ...
  },
  {
    ...
    status: 'DRAFT',
    totalAmount: 3840,
    expectedDelivery: '2026-07-30T09:00:00Z',
  ...
  },
  {
    ...
    supplierId: 's5',
    supplierName: 'Ramset Australia',
    status: 'DELIVERED',
    totalAmount: 1330,
    expectedDelivery: '2026-07-20T08:00:00Z',
  ...
  },
  {
    ...
    supplierId: 's6',
    supplierName: 'Parchem Construction',
    status: 'ORDERED',
    totalAmount: 2352,
    expectedDelivery: '2026-07-27T07:00:00Z',
    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          {
            label: 'Awaiting',
            value: String(POS.filter((p) => p.status === 'PARTIALLY_RECEIVED').length),
          },
          { label: 'Total Value', value: fmtCurrency(totalValue) },
        ].map((s) => (
          <div
            key={s.label}
            className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-sm px-4 py-2.5"
          >
        ...
        <table className="w-full text-xs">
          <thead className="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800">
            <tr>
              ...
              <th className="text-right px-4 py-2.5 font-bold uppercase tracking-wider text-slate-500 text-[10px] hidden lg:table-cell">
                Expected Delivery
              </th>
            </tr>
          </thead>
            ...
            {POS.map((po) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-3 py-2.5 text-slate-700 dark:text-slate-300 hidden sm:table-cell">
                    {po.supplierName}
                  </td>
                  <td className="px-3 py-2.5">
                    <div className="flex items-center gap-1.5">
                      ...
                      {isOverdue && (
                        <span className="text-[9px] font-bold font-mono text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900 px-1 py-px rounded-sm">
                          OVERDUE
                        </span>
                      )}
                    </div>
                  ...
                  <td
                    className={`px-4 py-2.5 text-right font-mono text-[11px] hidden lg:table-cell ${isOverdue ? 'text-red-600 dark:text-red-400 font-semibold' : 'text-slate-500'}`}
                  >

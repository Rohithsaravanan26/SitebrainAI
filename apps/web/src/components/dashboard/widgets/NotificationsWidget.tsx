...
const NOTIFICATIONS: Notification[] = [
  {
    id: 'n1',
    type: 'safety',
    title: 'PPE Non-Compliance — Level 13',
    detail: 'Camera #7 flagged 2 workers without helmets at grid G-12.',
    time: '9m ago',
    read: false,
  },
  {
    id: 'n2',
    type: 'delivery',
    title: 'N16 Rebar Delivery Confirmed',
    detail: 'BlueScope Steel delivery ETA: 14:30 today. Receive at Gate 3.',
    time: '22m ago',
    read: false,
  },
  {
    id: 'n3',
    type: 'rfi',
    title: 'RFI #247 — Structural Response',
    detail: 'Tier 1 Structures responded to footing setdown query. Review.',
    time: '1h ago',
    read: false,
  },
  {
    id: 'n4',
    type: 'approval',
    title: 'Submittal #89 Approved',
    detail: 'Concrete mix design M25 has been approved by structural eng.',
    time: '2h ago',
    read: true,
  },
  {
    id: 'n5',
    type: 'safety',
    title: 'Near-Miss Report — Scaffold Lvl 9',
    detail: 'Reported by J. Chen. Scaffold board dislodged. Review SWMS.',
    time: '4h ago',
    read: true,
  },
  {
    id: 'n6',
    type: 'system',
    title: 'Daily Progress Report Generated',
    detail: 'Automated progress report for 24 Jul 2026 is ready to review.',
    time: '6h ago',
    read: true,
  },
  {
    id: 'n7',
    type: 'delivery',
    title: 'Formwork Ply — Short Delivery',
    detail: 'Boral Timber delivered 180/250 sheets. Raise purchase order.',
    time: '8h ago',
    read: true,
  },
];
...
const typeConfig: Record<NotificationType, { icon: React.ReactNode; accent: string }> = {
  safety: {
    ...
    accent: 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/40',
  },
  delivery: {
  ...
  system: {
    ...
    accent: 'text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800',
  },
};
        ...
        {NOTIFICATIONS.map((notif) => {
          ...
          return (
            ...
            >
              {/* Type Icon */}
              <div
                className={`flex h-7 w-7 items-center justify-center rounded-sm shrink-0 mt-0.5 ${config.accent}`}
              >
                {config.icon}
              </div>

...
const UPLOADS: Upload[] = [
  {
    id: 'u1',
    type: 'photo',
    filename: 'lvl14_pour_progress_0724.jpg',
    location: 'Lvl 14 — Grid G-H',
    uploadedBy: 'J. Chen',
    time: '08:47',
    sizeKb: 4821,
  },
  {
    id: 'u2',
    type: 'drawing',
    filename: 'SK-STRUCT-C-187_Rev3.pdf',
    location: 'Lvl 10–12 Transfer',
    uploadedBy: 'S. Okafor',
    time: '09:12',
    sizeKb: 2340,
  },
  {
    id: 'u3',
    type: 'photo',
    filename: 'crane_inspection_report.jpg',
  ...
  },
  {
    id: 'u4',
    type: 'document',
    filename: 'SWMS_concrete_pour_L14.pdf',
  ...
  },
  {
    id: 'u5',
    type: 'video',
    filename: 'drone_ortho_240724_blockC.mp4',
    location: 'Site Aerial',
    uploadedBy: 'AutoDrone',
    time: '10:02',
    sizeKb: 94200,
  },
  {
    id: 'u6',
    type: 'photo',
    filename: 'rebar_insp_lvl13_NE_corner.jpg',
    location: 'Lvl 13 — NE Corner',
    uploadedBy: 'T. Nakamura',
    time: '10:18',
    sizeKb: 3640,
  },
  {
    id: 'u7',
    type: 'drawing',
    filename: 'ITP-CIVIL-009_signed.pdf',
    location: 'QA Records',
    uploadedBy: 'L. Ferreira',
    time: '11:04',
    sizeKb: 890,
  },
  {
    id: 'u8',
    type: 'document',
    filename: 'delivery_docket_bluescope_0724.pdf',
    location: 'Gate 3 Laydown',
    uploadedBy: 'O. Fischer',
    time: '14:22',
    sizeKb: 120,
  },
];
      ...
      <table className="w-full text-xs">
        <thead className="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800">
          <tr>
            ...
            <th className="text-left px-3 py-2 font-bold uppercase tracking-wider text-slate-500 text-[10px] hidden md:table-cell">
              Location
            </th>
            <th className="text-left px-3 py-2 font-bold uppercase tracking-wider text-slate-500 text-[10px] hidden sm:table-cell">
              Uploaded By
            </th>
            <th className="text-right px-3 py-2 font-bold uppercase tracking-wider text-slate-500 text-[10px] hidden lg:table-cell">
              Size
            </th>
            <th className="text-right px-4 py-2 font-bold uppercase tracking-wider text-slate-500 text-[10px]">
              Time
            </th>
          </tr>
        </thead>
              ...
              >
                <td className="px-4 py-2.5">
                  <div className="flex items-center gap-2">
                    <div
                      className={`flex h-6 w-6 items-center justify-center rounded-sm shrink-0 ${config.bg} ${config.text}`}
                    >
                      {config.icon}
                    </div>
                    <div className="min-w-0">
                      ...
                      <span
                        className={`text-[9px] font-bold font-mono tracking-wider ${config.text}`}
                      >
                        {config.label}
                      </span>
                    </div>

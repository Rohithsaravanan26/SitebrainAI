...
const EQUIPMENT: Equipment[] = [
  ...
  {
    id: 'e2',
    name: 'Schwing BP 4000 Concrete Pump',
    type: 'Concrete Pump',
    operator: 'R. Hassan',
    utilisation: 74,
  ...
  },
  {
    ...
    nextService: '10 Aug 2026',
    status: 'at-risk',
  },
  {
    id: 'e4',
    name: 'Caterpillar 323 Excavator',
    type: 'Excavator',
    operator: 'O. Fischer',
    utilisation: 0,
  ...
  {
    id: 'e5',
    name: 'Somero S-22E Laser Screed',
    type: 'Concrete Tool',
    operator: 'L. Mbeki',
    utilisation: 65,
    lastService: '25 Jun 2026',
      ...
      <table className="w-full text-xs">
        <thead className="bg-slate-50 dark:bg-slate-800/60 border-b border-slate-200 dark:border-slate-800">
          <tr>
            ...
            <th className="text-left px-3 py-2 font-bold uppercase tracking-wider text-slate-500 text-[10px]">
              Status
            </th>
            <th className="text-right px-4 py-2 font-bold uppercase tracking-wider text-slate-500 text-[10px] hidden md:table-cell">
              Next Service
            </th>
          </tr>
        </thead>
            ...
            >
              ...
              <td className="px-3 py-2.5 text-right hidden sm:table-cell">
                <div className="flex items-center justify-end gap-1.5">
                  ...
                  <span className="font-mono text-[11px] text-slate-600 dark:text-slate-400 w-7 text-right">
                    {eq.utilisation}%
                  </span>
                </div>
              </td>

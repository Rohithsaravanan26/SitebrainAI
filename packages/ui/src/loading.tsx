...
export const SkeletonCard: React.FC<{ className?: string }> = ({ className }) => (
  <div className={cn('p-4 border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-sm space-y-3', className)}>
...
export const SkeletonTable: React.FC<{ rows?: number; className?: string }> = ({ rows = 5, className }) => (
  <div className={cn('border border-slate-200 dark:border-slate-800 rounded-sm overflow-hidden bg-white dark:bg-slate-900 p-4 space-y-3', className)}>

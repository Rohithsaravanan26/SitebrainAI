...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      secondary:
        'bg-slate-100 text-slate-900 border-slate-200 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-100 dark:border-slate-700 dark:hover:bg-slate-700',
      outline:
      ...
      accent:
        'bg-orange-600 text-white border-orange-600 hover:bg-orange-700 dark:bg-orange-600 dark:border-orange-600 dark:hover:bg-orange-700',
      ghost:
        'bg-transparent text-slate-700 border-transparent hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white',
      danger:
        'bg-red-700 text-white border-red-700 hover:bg-red-800 dark:bg-red-800 dark:border-red-800',
    };
